...
| **1:10** | CR-0001: Diff, Checks, Impact | Point at the two diff rows, then the headline, then Top movers | "Look at the diff: I said 'Sale VAT'. Claude changed the standard rate *and* its price-included twin, which a person usually forgets. The replay says 73 of 120 invoices move by EUR 4,502.70, and here is who is affected. The reviewer approves a number, not a setup screen." |
...
| Claude's proposal | about 10 seconds; explanation about 6 seconds |
